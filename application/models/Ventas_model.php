...
class Ventas_model extends CI_Model {
    ...
    public function getVentas(){
        $this->db->select("v.*,c.nombre,c.num_documento,tc.nombre as tipocomprobante,p.nombre as nomproducto,p.precio,d.importe,d.cantidad");
        $this->db->from("ventas v");
        $this->db->join("clientes c","v.cliente_id = c.id");
        $this->db->join("tipo_comprobante tc","v.tipo_comprobante_id = tc.id");
        $this->db->join("detalle_venta d","d.venta_id = v.id");
