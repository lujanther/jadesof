    ...
    class Ventas extends CI_Controller {
        ...
        public function index(){
            $data = array(
                'ventas' =>$this->Ventas_model->getVentas2(),
            );
        ...
        public function store(){
            ...
            if($this->Ventas_model->save($data)){
                ...
                $this->save_detalle($idproducto,$idventas,$precios,$cantidades,$importes);
            ...
            protected function save_detalle($producto,$idventas,$precios,$cantidades,$importes){
                for ($i=0; $i < count($producto); $i++){
                    ...
                    $this->updateProducto($producto[$i],$cantidades[$i]);
                }
            }
